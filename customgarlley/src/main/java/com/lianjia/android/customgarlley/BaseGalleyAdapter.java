 ...
 *            list<T>
 */
public abstract class BaseGalleyAdapter<T> extends BaseAdapter {
	...
	public BaseGalleyAdapter(Context context) {
	 ...
	 */
	protected void onSetViewHolder(int position, T bean, BaseViewHolder baseViewHolder) {
		baseViewHolder.setView(position, bean, getContext());
	...
	public static abstract class BaseViewHolder<T> {
		 ...
		 * @param context
		 */
		protected abstract void setView(int position, T bean, Context context);
